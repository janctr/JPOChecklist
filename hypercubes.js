...
const tables = [
    ...
    {
        table: 'Supplier Information',
        tableId: 'supplier-information-table',
        notesTableKey: 'Supplier_Information',
        dimensions: [
            { column: 'vendor_name', name: 'Vendor Name' },
            { column: 'supplier_product', name: 'Product' },
            { column: 'Distance', name: 'Distance' },
            {
                column: 'supplier_20hr_delivery',
                name: '20 Hour Delivery Capability',
            },
            {
                column: 'supplier_24hr_delivery',
                name: '24 Hour Delivery Capability',
            },
            { column: 'vendor_tank_cap', name: "Vendor's Tank Capacity" },
            { column: 'vendor_supplier', name: "Vendor's Supplier" },
            { column: 'supplier_notes', name: 'Notes' },
        ],
    },
    {
        table: 'Other Miscellaneous Information',
